...
def generate_dataset(data_dir):
    ...
    #)
    train_data_conf = DatasetConfig(
        audio_conf, data_dir, "C:/Users/MaggieEzzat/Desktop/tuda-tpu/data/vocabulary.txt", True
    )
...
def convert_to_TF(deep_speech_dataset, tf_records_path="E:/TUDA/german-speechdata-package-v2/test1024.tfrecords"):
#def convert_to_TF(deep_speech_dataset, tf_records_path="gs://german-speechdata-package-v2/test.tfrecords"):
  ...
  featuresA =[]
  labelsA = []
  for audio_file, _, transcript in data_entries[:1024]:
